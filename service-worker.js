const CACHE = 'samara-erp-1.3.30-physiotherapy-plan-id-fix';
const SHELL = [
  './', './index.html', './styles.css?v=1.3.30', './app.js?v=1.3.30',
  './bootstrap-error.js?v=1.3.30', './health-check.js?v=1.3.30',
  './config.js?v=1.3.30', './manifest.webmanifest',
