const CACHE = 'samara-erp-1.3.44-return-page-scope-fix';
const SHELL = [
  './', './index.html', './styles.css?v=1.3.44', './app.js?v=1.3.44',
  './bootstrap-error.js?v=1.3.44', './health-check.js?v=1.3.44',
  './config.js?v=1.3.44', './manifest.webmanifest',
