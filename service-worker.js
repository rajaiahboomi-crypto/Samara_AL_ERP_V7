const CACHE = 'samara-erp-1.3.31-rooms-tariff-transfer';
const SHELL = [
  './', './index.html', './styles.css?v=1.3.31', './app.js?v=1.3.31',
  './bootstrap-error.js?v=1.3.31', './health-check.js?v=1.3.31',
  './config.js?v=1.3.31', './manifest.webmanifest',
