const CACHE = 'samara-erp-1.3.38-patient-worklist-null-guard';
const SHELL = [
  './', './index.html', './styles.css?v=1.3.38', './app.js?v=1.3.38',
  './bootstrap-error.js?v=1.3.38', './health-check.js?v=1.3.38',
  './config.js?v=1.3.38', './manifest.webmanifest',
