const CACHE = 'samara-erp-1.3.43-universal-action-return';
const SHELL = [
  './', './index.html', './styles.css?v=1.3.43', './app.js?v=1.3.43',
  './bootstrap-error.js?v=1.3.43', './health-check.js?v=1.3.43',
  './config.js?v=1.3.43', './manifest.webmanifest',
