const CACHE = 'samara-erp-1.3.33-room-status-occupant-dropdown';
const SHELL = [
  './', './index.html', './styles.css?v=1.3.33', './app.js?v=1.3.33',
  './bootstrap-error.js?v=1.3.33', './health-check.js?v=1.3.33',
  './config.js?v=1.3.33', './manifest.webmanifest',
