const CACHE = 'samara-erp-1.3.32-admission-available-rooms-dropdown';
const SHELL = [
  './', './index.html', './styles.css?v=1.3.32', './app.js?v=1.3.32',
  './bootstrap-error.js?v=1.3.32', './health-check.js?v=1.3.32',
  './config.js?v=1.3.32', './manifest.webmanifest',
